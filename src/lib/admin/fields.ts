...
export const homeTabs: EditorTab[] = [
  ...
  },
  {
    ...
    label: "Sections",
    fields: [
      { kind: "text", name: "sections.trust", label: "Trust strip title" },
      { kind: "text", name: "sections.problems", label: "Problem statement title" },
      { kind: "text", name: "sections.pillars", label: "Solution pillars title" },
      { kind: "text", name: "sections.products", label: "Products title" },
      { kind: "text", name: "sections.industries", label: "Industries title" },
      { kind: "text", name: "sections.method", label: "Method title" },
      { kind: "text", name: "sections.proof", label: "Proof title" },
...
export const productRecordFields: AdminField[] = [
  ...
  { kind: "text", name: "outcomeHeadline", label: "Outcome headline" },
  { kind: "text", name: "primaryUser", label: "Primary user" },
  { kind: "text", name: "primaryWorkflow", label: "Primary workflow" },
...
export const industryRecordFields: AdminField[] = [
  ...
  { kind: "stringList", name: "priorityProblems", label: "Priority problems" },
