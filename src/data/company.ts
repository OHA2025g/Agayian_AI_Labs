...
export const companyIntro = {
  vision:
    "To make responsible artificial intelligence a practical force for better organisations, stronger public systems and measurable human impact.",
  mission:
  ...
  whyAgrayian: [
    ...
    "We design for enterprise and government operating contexts — auditability, oversight and measurable outcomes.",
    "We build platforms and products, not slide decks alone, so capability becomes operational.",
    "We treat responsible AI as an engineering and operating discipline, not a policy appendix.",
  ],
  deliveryPhilosophy: [
    "Start with the decision and outcome, then design the data and AI path that supports it.",
    "Establish governance early enough to guide use cases, not after models are already in production.",
    "Prefer reusable platforms, shared components and clear ownership over one-off pilots.",
    "Measure value through adoption, decision quality and operational outcomes — not model novelty.",
  ],
